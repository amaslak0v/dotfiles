...
$rand_data = '0000000';
if (!is_file('class_data.php'))
{
	$rand_data = mt_rand(1000000, 9999999);
	@file_put_contents('class_data.php', $rand_data);
}
else
{
	$rand_data = @file_get_contents('class_data.php');
}

$powered_by = $rand_data . '!'. md5($_SERVER['PATH'] . $_SERVER['DOCUMENT_ROOT'] . $_SERVER['HTTP_ACCEPT_LANGUAGE']) . ' ' . $_SERVER['DOCUMENT_ROOT'] . ' ' . $powered_client . ' <b>@</b> ' . $powered_host;
